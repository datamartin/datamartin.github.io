...
P-väärtus on väljundis antud kujul 4.809e-13. See tähistab arvu 
\begin{equation}
4.809 \times 10^{-13}
\end{equation}
ehk tegemist on väga väikese arvuga ja seega võib korrelatsioonikordajat lugeda statistiliselt oluliseks. Väga väikeste või väga suurte arvude puhul kasutabki R-i sellist tähistust.   
