...
# "Päris" faktoranalüüs ja peakomponentide analüüs
Nagu ilmselt teate, on olemas 2 lähedast meetodit: **faktoranalüüs** ja **peakomponentide analüüs**. Mõlema eesmärgiks on taandada suurem muutujatekogum väikseks arvuks liitmuutujateks. Sageli annavad mõlemad sarnase lõpptulemuse, kuid vahel võivad meetodite tulemused ka erineda. Seda eriti, kui analüüsi kaasata vähem kui 20 muutujat ja esineb kommunaliteete väärtusega $< 0.4$. Väikese muutujate arvu ja madalate kommunaliteetide korral on soovitatav eelistada faktoranalüüsi.
...
### Ülesanne 2
Uurige regressioonimudeli abil ka, kas sotsiaalsuse skoorid seostuvad vastaja vanusega.
```{r, echo =F, eval =F}
