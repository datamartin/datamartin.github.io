---
title: 'Kvantitatiivsed mudelid käitumisteadustes - praktikum nr 6: struktuurivõrrandite
  mudelid'
...
---
```{r, echo = F}
HolzingerSwineford1939 <- read.csv2("HolzingerSwineford1939.csv")
suur.viisik <- read.csv2("suur.viisik.csv")
illness.cov <- read.csv2("illness.cov.csv")
PoliticalDemocracy <- read.csv2("PoliticalDemocracy.csv", sep =",")
```
...
Sobitame mudeli andmetele ja uurime väljundit. Kuna mudel sisaldab ka regressioonseoseid, siis kasutame sobitamiseks funktsiooni sem. (Kuigi tegelikult teevad vähemalt praeguse seisuga funktsioonid *cfa* ja sem sama asja, siis tulevikus võib see olukord muutuda.) Kas mudel sobib andmetega?
